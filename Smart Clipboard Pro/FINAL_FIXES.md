...
- **Solution**: 
  - Added "⭐ Pro" button in popup header → Opens Gumroad
...
### Purchase/Upgrade:
1. **In Popup**: Click "⭐ Pro" button in header → Opens Gumroad
2. **In Settings**: License Activation section → Link to Gumroad + activation form
...
3. **Permissions**: Added "tabs" permission for opening Gumroad link

...
const LICENSE_SECRET = process.env.OFFLINE_LICENSE_SECRET || process.env.LICENSE_SECRET;
if (!LICENSE_SECRET) {
    console.error('Missing license secret. Set OFFLINE_LICENSE_SECRET or LICENSE_SECRET.');
    process.exit(1);
}

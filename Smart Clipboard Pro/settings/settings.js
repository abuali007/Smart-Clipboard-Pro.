...
class SettingsManager {
    ...
    setupEventListeners() {
        ...
        if (licenseInput) {
            ...
            licenseInput.addEventListener('input', (e) => {
                ...
                const formatted = value.match(/.{1,8}/g)?.join('-') || value;
    ...
    updateLicenseUI() {
            ...
            this.setSafeContent(statusDiv, `
                <div class="license-inactive">
                    ...
                    <div class="status-details">
                        ...
                        <p>You can still enter your Gumroad license key below.</p>
                    </div>
                </div>
            `);
            if (messageDiv) {
        ...
        if (isActive) {
            ...
            const renewalText = isSubscriptionPlan
                ? (this.licenseInfo.subscriptionCancelled
                    ...
                    : `Next renewal: ${this.formatDateTime(this.licenseInfo.nextChargeAt, 'scheduled by Gumroad')}`)
            ...
            this.setSafeContent(statusDiv, `
                <div class="license-inactive">
                    ...
                    <div class="status-details">
                        ...
                        <p>Please renew your Gumroad subscription or purchase a new 30-day pass.</p>
                    </div>
                </div>
            `);
        ...
        this.setSafeContent(statusDiv, `
            <div class="license-inactive">
                ...
                <div class="status-details">
                    ...
                    <p><a href="https://litextools.gumroad.com/l/imwysv" target="_blank">Purchase subscription &#128722;</a></p>
                </div>
            </div>
        `);
        ...
        this.updateExpiryIndicator('');
        if (messageDiv) {
            messageDiv.textContent = 'Enter the license key from your Gumroad receipt (format: XXXXXXXX-XXXXXXXX-XXXXXXXX-XXXXXXXX).';
            messageDiv.className = 'license-message info';
        }
        this.setPremiumControlsEnabled(false);
        this.toggleHistoryClearButton(false);
    ...
    async activateLicense() {
        ...
        if (!cleanedKey || cleanedKey.length !== 32) {
            if (messageDiv) {
                messageDiv.textContent = 'Please enter a valid 32-character license key';
                messageDiv.className = 'license-message error';
            }
            return;
        }
        ...
        const formattedKey = cleanedKey.match(/.{1,8}/g)?.join('-') || cleanedKey;

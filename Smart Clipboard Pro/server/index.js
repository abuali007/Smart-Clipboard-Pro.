...
app.get('/activate', (req, res) => {
    ...
    const extUrl = license ? `${extUrlBase}?license=${encodeURIComponent(license)}` : extUrlBase;
...
<body>
  ...
  <p><strong>License key:</strong><br><code>${license || 'No license key provided'}</code></p>
  <p>
    <a class="button" href="${extUrl}">Open extension & activate</a>
  </p>

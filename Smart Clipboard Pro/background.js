...
const LICENSE_API_BASE_URL = 'http://localhost:3000'; // Update to your deployed license server base URL
...
function validateLicenseKey(licenseKey) {
    ...
    if (!normalized || !LICENSE_PATTERN.test(normalized)) {
        return { valid: false, error: 'Invalid license format. Use XXXX-XXXX-XXXX-XXXX' };
    }

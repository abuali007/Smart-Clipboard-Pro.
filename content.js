// Smart Clipboard Pro Enhanced - Content Script v5.0
// ================================================
...
(function() {
    ...
    async function init() {
        try {
            console.log('Smart Clipboard Pro Enhanced - Content Script v5.0 initialized');
    ...
    async function fallbackSaveToHistory(text) {
        try {
            ...
            const newItem = {
                id: `fallback-${Date.now()}-${Math.random().toString(36).slice(2, 7)}`,
                text,
                timestamp: Date.now(),
